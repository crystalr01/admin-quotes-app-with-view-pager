...
public class UploadTrendingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload_trending);
        ...
        getSupportActionBar().setTitle("Upload Trending");
        ...
        uploadBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (categoryImage == null) {
                    ...
                    uploadData();
                    Toast.makeText(UploadTrendingActivity.this, "Please select image", Toast.LENGTH_SHORT).show();
                } else {
                    uploadImage();
                }
            }
    ...
    private void uploadImage() {
        ...
        filepath = storageReference.child("Untold").child("viewPager").child(finalimg + "jpg");
        final UploadTask uploadTask = filepath.putBytes(finalimg);
        uploadTask.addOnCompleteListener(UploadTrendingActivity.this, new OnCompleteListener<UploadTask.TaskSnapshot>() {
            @Override
            public void onComplete(@NonNull @NotNull Task<UploadTask.TaskSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(UploadTrendingActivity.this, "Something went wrong...", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void uploadData() {
        ...
        reference = reference.child("Untold").child("viewPager");
        ...
        UploadImage uploadData = new UploadImage(downloadUrl,uniqkey);

        reference.child(uniqkey).setValue(uploadData).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void unused) {
                loadingDialogue.dismiss();
                Toast.makeText(UploadTrendingActivity.this, "Upload success!", Toast.LENGTH_SHORT).show();
                onBackPressed();
